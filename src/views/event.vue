...
<div class="event-content">
  ...
  <div class="event-content__top-section" v-if="!loader">
    ...
    <div class="event-content__content">
          ...
          <div class="share-content">
            ...
            <div class="share-content__item" :class="{active: shareBtnState}" @click="shareBtnState = !shareBtnState">
              ...
              <div class="share-links" v-if="shareBtnState">
                <a :href="twitter">
                  <svg class="icon-pack">
                    <use xlink:href="../assets/icons.svg#twitter-logo"></use>
                  </svg>
                </a>
                <a :href="linkedin">
                  <svg class="icon-pack">
                    <use xlink:href="../assets/icons.svg#linkedin-logo"></use>
                  </svg>
                </a>
                <a :href="telegram">
                  <svg class="icon-pack">
      ...
      <div class="info">
        ...
        <div class="info__item">
          <div class="info__item__icon">
            <svg>
              <use xlink:href="../assets/icons.svg#photo-camera"></use>
            </svg>
          </div>

          <div class="info__item__details">
            <h4 class="info__item__details__title">عکاس</h4>
            <span class="info__item__details__type"> {{ photographer }} </span>
          </div>
        </div>
  ...
  <div class="event-content__tabs" v-if="!loader">
    ...
    <div class="event-content__tabs__body">
      ...
      <div :class="{active: states[2]}" class="tab-3">
        ...
        <div class="tab-3__add-comment" v-if="!loginState">
          ...
          <div class="tab-3__add-comment__login" @click="goToLogin">
...
export default {
  ...
  computed: {
    ...
    url() {
      return 'http://chaarpaye.ir/' + 'event?id=' + this.eventId
    },
    loginState() {
      return this.$store.getters.loginState
    },
